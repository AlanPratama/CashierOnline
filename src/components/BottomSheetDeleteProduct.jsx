...
export default function BottomSheetDeleteProduct({ fetch, db, refRBSheet, deleteProduct }) {
  ...
  return (
    <View>
        ...
        openDuration={250}
      >
        <DeleteProductComp fetch={fetch} db={db} refRBSheet={refRBSheet} deleteProduct={deleteProduct} />
      </RBSheet>
    </View>
  )
}
